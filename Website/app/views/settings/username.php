        ...
        <div class="single-blog wow fadeIn" style="margin: 50px;">
			...
			<div class="blog-details " >
                ...
                <div class="form-group" style="padding: 20px;">
					...
					<form action="<?=PROOT?>settings/username" method="post">
					<div class="bg-danger"><?= $this->displayErrors ?></div>
						...
						<label class="col-sm-4 control-label" for="username">Enter the new username:</label>
						<div class="col-sm-5">
						<input class="form-control" id="username" name="username" placeholder="Enter the user name" type="text"/>
						</div>
