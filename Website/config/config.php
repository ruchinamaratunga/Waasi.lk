<?php   
    ...
    define('IMAGE_STORE_PATH','/home/damika/lampp/htdocs/WebProject/alphapack-Refactor/Website/img/Promotions/');   // Location to where promotion images should be stored
